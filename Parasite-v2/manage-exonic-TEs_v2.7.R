...
#list <- rep("yes",length(TEcandidates_ss))
#TEcandidates_ss <- cbind(TEcandidates_ss,list)
...
# Rule 1: Intergenic TEs showing ATP & AS (RI, SE, A5SS, A3SS)
# If the TE is specified as "intergenic", do not give AS prediction, this remove a lot of false positif
# to improve maybe if == begining or ending and if ATP <> NA
...
#Rule2: If the Freq_TE_isoform is 1 and that the AS check is false (no overlap with a splicing site), do not give AS prediction
...
#Rule 3: If Intragenic and Freq_TEs_isoform==1 and ATP_check is FALSE, no ATP 
detailed_join_gene5 <- detailed_join_gene
detailed_join_gene$Alternative_transcription <- ifelse(detailed_join_gene$TE_localisation=="Intragenic" & detailed_join_gene$Freq_TE_isoform==1 & detailed_join_gene$ATP_check==FALSE,NA, detailed_join_gene5$Alternative_transcription )

#Rule 4:
detailed_join_gene6 <- detailed_join_gene
detailed_join_gene$Alternative_splicing <- ifelse(!is.na(detailed_join_gene$Alternative_transcription) & detailed_join_gene$TE_localisation=="Intragenic" &  detailed_join_gene$AS_check==FALSE & ( detailed_join_gene$TE_position_isoform=="begining" | detailed_join_gene$TE_position_isoform=="ending" | detailed_join_gene$TE_position_isoform=="single"),
NA, detailed_join_gene6$Alternative_splicing )

#Rule 5: 
#If Intergenic and Freq_TE_isoform==1 and obtain with method 3, no ATP
#detailed_join_gene7 <- detailed_join_gene
#detailed_join_gene$Alternative_transcription <- ifelse(detailed_join_gene$TE_localisation=="Intergenic" & detailed_join_gene$Freq_TE_isoform==1 & detailed_join_gene$method=="3",NA, detailed_join_gene7$Alternative_transcription )

#Rule 6: off 
#detailed_join_gene7 <- detailed_join_gene
#detailed_join_gene$Alternative_splicing <- ifelse( detailed_join_gene$Freq_TE_isoform==1 & detailed_join_gene$TE_localisation=="Intragenic" & detailed_join_gene$AS_check==TRUE & ( detailed_join_gene$TE_position_isoform=="middle"),
#NA, detailed_join_gene7$Alternative_splicing )
