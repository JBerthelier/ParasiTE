...
detailed_join_gene_check$Exon_check_start <- ifelse((detailed_join_gene_check$TE_start<detailed_join_gene_check$exon_start) & (detailed_join_gene_check$TE_position_isoform=="begining" | detailed_join_gene_check$TE_position_isoform=="ending"),TRUE,FALSE)

detailed_join_gene_check$Exon_check_end <- 0
detailed_join_gene_check$Exon_check_end <- ifelse((detailed_join_gene_check$TE_end>detailed_join_gene_check$exon_end) & (detailed_join_gene_check$TE_position_isoform=="begining" | detailed_join_gene_check$TE_position_isoform=="ending"),TRUE,FALSE)
