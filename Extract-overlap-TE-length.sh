...
awk -F "\t" '{$12 = ($3-$2)} 1' OFS='\t' ../Results/Annotations_TEs/Overlap_TEs_downstream.bed > Overlap-TE-downstream.figure.bed && 
...
awk -F "\t" '$10 ~ "=RYX" {print}' ./Overlap-TE-downstream.figure.bed | awk -F "\t" '{print $12 }' > RYX-overlap-TE-downstream.bed &&
...
awk -F "\t" '{$12 = ($3-$2)} 1' OFS='\t' ../Results/Annotations_TEs/Overlap_TEs_upstream.bed > Overlap-TE-upstream.figure.bed && 
...
awk -F "\t" '$10 ~ "=RYX" {print}' ./Overlap-TE-upstream.figure.bed | awk -F "\t" '{print $12 }' > RYX-overlap-TE-upstream.bed &&
...
#Sort full TEs
awk -F "\t" '{$12 = ($3-$2)} 1' OFS='\t'  ../Results/Annotations_TEs/Overlap_TEs_full.bed > Overlap_TEs_full.figure.bed&& 
...
awk -F "\t" '$10 ~ "=RYX" {print}' ./Overlap_TEs_full.figure.bed| awk -F "\t" '{print $12 }' > RYX-overlap-TE-full.bed &&
