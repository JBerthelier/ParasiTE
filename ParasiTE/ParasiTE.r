...
#There is an error here, the number of column is different between Stringtie2 long read "paste0("id", 1:5)" or short read "paste0("id", 1:6)", I used the fonction mtry to fix that
...
cat("ParasiTE finished successfully")
