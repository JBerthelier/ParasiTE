...
3) de novo transcriptome annotation in .gtf file generated by Stringtie2 (version 2.14 was used) (https://ccb.jhu.edu/software/stringtie/)
...
ParasiTE outputs are in ParasiTE_output (a new run of ParasiTE will delet the previous if the name havent be changed):
