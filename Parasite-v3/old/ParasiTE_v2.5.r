...
option_list = list(
    ...
    make_option(c("-i", "--Tintron"), type="character", default=0.10, 
              help="Proportion of exons that an that a TEs can partialy overlap to be ambigous, [default= %default] (0.05%)", metavar="number"),
    make_option(c("-e", "--Texon1"), type="character", default=0.8, 
              help="Minimum proportion of a TEs in an exon to be considered as fully exonic, [default= %default] (25%)", metavar="number"),       
...
####Partial Exonic -method3 
#2.2.3 create a new annotation without the full exonic TEs detected with method 1 and method 2, here the goal is to find TE that at leat overlap with 20% 
...
system(paste("bedtools intersect -F ", opt$Tintron, " -nonamecheck -wo -a ../ParasiTE_output/TEannotation_wo_exonicTEs.bed  -b ../ParasiTE_output/exon_transcript_annotation.woshort.bed > ../ParasiTE_output/partialy_exonic_TEs.bed && 
...
system(paste("Rscript ./manage-exonic-TEs_v2.5.R"))
