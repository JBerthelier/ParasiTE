...
system(paste("mkdir ../ParasiTE_output/Results/STEP5_altTE-G_candidates/"))
#(in progress)
...
TE_annotation_candidate <- detailed_join_gene[,c("TE_chromosome", "TE_start", "TE_end", "Exonic_id")]
...
five_check <- detailed_join_gene$Exonic_id %in% five_results$Exonic_id
...
three_check <- detailed_join_gene$Exonic_id %in% three_results$Exonic_id
...
write.table(overview_gene_TE_alternative,file="../ParasiTE_output/Results/STEP5_altTE-G_candidates/List_altTE-G.tab",sep = "\t",row.names=F,col.names=T)
...
write.table(detailed_join_gene_alternative,file="../ParasiTE_output/Results/STEP5_altTE-G_candidates/List_altTE-G_exonic_level.tab",sep = "\t",row.names=F,col.names=T)
