...
#load data
if (file.exists("../ParasiTE_output/neighbor_TEs/RLC-neighbor_TEs-upstream.bed"))
RLC <- read.delim("../ParasiTE_output/neighbor_TEs/RLC-neighbor_TEs-upstream.bed", header = FALSE, sep = "\t", dec = ".")

if (file.exists("../ParasiTE_output/neighbor_TEs/RLG-neighbor_TEs-upstream.bed"))
RLG <- read.delim("../ParasiTE_output/neighbor_TEs/RLG-neighbor_TEs-upstream.bed", header = FALSE, sep = "\t", dec = ".")

if (file.exists("../ParasiTE_output/neighbor_TEs/Caulimoviridae-neighbor_TEs-upstream.bed"))
Caulimoviridae <- read.delim("../ParasiTE_output/neighbor_TEs/Caulimoviridae-neighbor_TEs-upstream.bed", header = FALSE, sep = "\t", dec = ".")

if (file.exists("../ParasiTE_output/neighbor_TEs/RIX-neighbor_TEs-upstream.bed"))
RIX <- read.delim("../ParasiTE_output/neighbor_TEs/RIX-neighbor_TEs-upstream.bed", header = FALSE, sep = "\t", dec = ".")

if (file.exists("../ParasiTE_output/neighbor_TEs/RLX-neighbor_TEs-upstream.bed"))
RLX <- read.delim("../ParasiTE_output/neighbor_TEs/RLX-neighbor_TEs-upstream.bed", header = FALSE, sep = "\t", dec = ".")

if (file.exists("../ParasiTE_output/neighbor_TEs/RXX-neighbor_TEs-upstream.bed"))
RXX <- read.delim("../ParasiTE_output/neighbor_TEs/RXX-neighbor_TEs-upstream.bed", header = FALSE, sep = "\t", dec = ".")

if (file.exists("../ParasiTE_output/neighbor_TEs/RSX-neighbor_TEs-upstream.bed"))
RSX <- read.delim("../ParasiTE_output/neighbor_TEs/RSX-neighbor_TEs-upstream.bed", header = FALSE, sep = "\t", dec = ".")

if (file.exists("../ParasiTE_output/neighbor_TEs/DTM-neighbor_TEs-upstream.bed"))
DTM <- read.delim("../ParasiTE_output/neighbor_TEs/DTM-neighbor_TEs-upstream.bed", header = FALSE, sep = "\t", dec = ".")

if (file.exists("../ParasiTE_output/neighbor_TEs/DTA-neighbor_TEs-upstream.bed"))
DTA <- read.delim("../ParasiTE_output/neighbor_TEs/DTA-neighbor_TEs-upstream.bed", header = FALSE, sep = "\t", dec = ".")

if (file.exists("../ParasiTE_output/neighbor_TEs/DTC-neighbor_TEs-upstream.bed"))
DTC <- read.delim("../ParasiTE_output/neighbor_TEs/DTC-neighbor_TEs-upstream.bed", header = FALSE, sep = "\t", dec = ".")

if (file.exists("../ParasiTE_output/neighbor_TEs/DTH-neighbor_TEs-upstream.bed"))
DTH <- read.delim("../ParasiTE_output/neighbor_TEs/DTH-neighbor_TEs-upstream.bed", header = FALSE, sep = "\t", dec = ".")

if (file.exists("../ParasiTE_output/neighbor_TEs/DTT-neighbor_TEs-upstream.bed"))
DTT <- read.delim("../ParasiTE_output/neighbor_TEs/DTT-neighbor_TEs-upstream.bed", header = FALSE, sep = "\t", dec = ".")

if (file.exists("../ParasiTE_output/neighbor_TEs/DTX-neighbor_TEs-upstream.bed"))
DTX <- read.delim("../ParasiTE_output/neighbor_TEs/DTX-neighbor_TEs-upstream.bed", header = FALSE, sep = "\t", dec = ".")

if (file.exists("../ParasiTE_output/neighbor_TEs/DHX-neighbor_TEs-upstream.bed"))
DHX <- read.delim("../ParasiTE_output/neighbor_TEs/DHX-neighbor_TEs-upstream.bed", header = FALSE, sep = "\t", dec = ".")

if (file.exists("../ParasiTE_output/neighbor_TEs/TXX-neighbor_TEs-upstream.bed"))
TXX <- read.delim("../ParasiTE_output/neighbor_TEs/TXX-neighbor_TEs-upstream.bed", header = FALSE, sep = "\t", dec = ".")

if (file.exists("../ParasiTE_output/neighbor_TEs/TOTAL-neighbor_TEs-upstream.bed"))
TOTAL <- read.delim("../ParasiTE_output/neighbor_TEs/TOTAL-neighbor_TEs-upstream.bed", header = FALSE, sep = "\t", dec = ".")
...
pdf(file = "../ParasiTE_output/lenght_neighbor_TEs_upstream.pdf")
